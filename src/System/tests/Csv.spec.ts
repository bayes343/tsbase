...
describe('Csv', () => {
  ...
  const json = [{ ID: '16504', WorkItemType: 'Issue', Title: 'Fix issues with code', AssignedTo: '', State: 'To Do', Priority: '1', Tags: 'Bug, Defect' }, { ID: '16505', WorkItemType: 'Issue', Title: 'Merge testing modules', AssignedTo: '', State: 'To Do', Priority: '3', Tags: '' }];
