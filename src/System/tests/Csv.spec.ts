...
describe('Csv', () => {
  const json = [{ ID: '16504', WorkItemType: 'Issue', Title: 'Fix issues with code, self, and face', AssignedTo: Strings.Empty, State: 'To Do', Priority: '1', Tags: 'Bug, Defect' }, { ID: '16505', WorkItemType: 'Issue', Title: 'Merge testing modules', AssignedTo: Strings.Empty, State: 'To Do', Priority: '3', Tags: Strings.Empty }];
...
"16504","Issue",""Fix issues with code, self, and face"",,"To Do","1",""Bug, Defect""\r\n\
...
5d52d4ee-16ac-4a45-9241-acefa27e0f7b,7/18/23 12:48,16,"
1 x $16.00 :
Subtotal : $16.00",1,,Houston,,Cris,Houston,,test@qa.org,444-555-1111,FALSE,paid,#N/A
5d52d4ee-16ac-4a45-9241-acefa27e0f7c,7/18/23 12:48,16,"
1 x $16.00 :
Subtotal : $16.00",1,,Houston,,Kris,Houston,,test@qa.org,444-555-1111,FALSE,paid,#N/A`;
  ...
  const expectedJson = [
    ...
    {
      id: '5d52d4ee-16ac-4a45-9241-acefa27e0f7b',
      date: '7/18/23 12:48',
      amountDue: '16',
      quantity: '1',
      family: 'Houston',
      customerFirstName: 'Cris',
      customerLastName: 'Houston',
      email: 'test@qa.org',
      phone: '444-555-1111',
      paymentStatus: 'paid'
    ...
    {
      id: '5d52d4ee-16ac-4a45-9241-acefa27e0f7c',
      date: '7/18/23 12:48',
      amountDue: '16',
      quantity: '1',
      family: 'Houston',
      customerFirstName: 'Kris',
      customerLastName: 'Houston',
      email: 'test@qa.org',
      phone: '444-555-1111',
      paymentStatus: 'paid'
